...
var returnValue = JSON.stringify(
    {
        user        : {
            name       : 'mway',
            uuid       : '75933d6f-7837-434d-b450-f1c7158c354d',
            salutation : null,
            givenName  : 'M-Way',
            surname    : 'Super',
            position   : null,
            email      : 'admin@mwaysolutions.com',
            phone      : null,
            country    : null,
            preferences: {}
        },
        organization: {
            name      : 'mway',
            uuid      : 'f8ad8e99-bc7a-4986-8fed-91a342bcafb5',
            uniqueName: 'mway'
        },
        roles       : [
            ...
            {
                name: 'WEBSERVICE_DEFINITION_CREATOR',
                uuid: 'WEBSERVICE_DEFINITION_CREATOR'
            },
...
/**
 * @todo its not running has no comments we dont no whats going on  08.10.2014 Pascal Brewing
 */
//
