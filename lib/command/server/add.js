    ...
    inquirer.prompt(
        ...
        function (answers) {
            if ( answers ) {
                ...
                if ( exist ) {
                    overwriteConfirm.message = chalk.red(rawAnswer.name) +overwriteConfirm.message;
                    ...
                    inquirer.prompt(
                        ...
                        function (answers) {
                            if ( answers.overwriteapp ) {
                                ...
                                console.log(chalk.bgGreen(chalk.yellow(figures.tick),chalk.white('Server is overwrite')));
