 ...
 */
module.exports.parse = function parse(command, attr) {
    if ( command === COMMAND_ADD ) {
        return module.exports.add(attr);
    }
    else if ( command === COMMAND_LIST ) {
        return module.exports.list(attr);
    }
    else if ( command === COMMAND_REMOVE ) {
        return module.exports.remove(attr);
    }
    else if ( command === COMMAND_DEFAULT ) {
        return module.exports.setDefault(attr[ 0 ]);
    }
    else {
		// dynamic dispatch
		var fn = module.exports[command];
 ...
 * @returns {*}
 */
module.exports.add = function add(attr) {
 ...
 * @returns {*}
 */
module.exports.get = function get(param) {
    try {
...
module.exports.list = function list() {
	var conf = module.exports.get();
    _.forOwn(conf.server, function (server) {
 ...
 * @returns {*}
 */
module.exports.remove = function remove(attr) {
    if ( !attr ) {
        return;
    }
 ...
 * @returns {*}
 */
module.exports.setDefault = function setDefault(attr) {
...
module.exports.clientcert = function clientcert(which, pfx, passphrase) {
    var conf = module.exports.get();
	var server = conf.server[which];
